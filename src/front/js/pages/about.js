      ...
      <div className="container-fluid py-5">
        ...
        <div className="text-center">
          ...
          <p className="text-muted">
            Learn more about our mission, history, and the team behind our
            platform.
          </p>
        ...
        <div className="row text-center mt-5">
          <div className="col-md-4">
            <div
              className="border border-danger shadow-lg p-4 bg-white"
              style={{ boxShadow: "0px 4px 10px rgba(225, 29, 29, 0.3)" }}
            >
          ...
          <div className="col-md-4">
            <div
              className="border border-danger shadow-lg p-4 bg-white"
              style={{ boxShadow: "0px 4px 10px rgba(255, 0, 0, 0.3)" }}
            >
        ...
        <div className="text-center mt-5">
          ...
          <div className="mt-3">
            <img
              src="https://i.pinimg.com/736x/74/f4/67/74f467ed1c5b5f4466ef5c396585c7ab.jpg"
              alt="Community"
        ...
        <div className="mt-5 text-center">
          ...
          <p className="text-muted">
            In our drive to facilitate exchanges of expertise and skills,{" "}
            <b>Skills & Swap</b> was born. Our mission is to connect individuals
            eager to trade their knowledge in an accessible way.
          </p>
          <p className="text-muted">
            We believe in <b>collaborative learning</b> and making skill
            exchange simple, fun, and rewarding.
          </p>
        </div>
